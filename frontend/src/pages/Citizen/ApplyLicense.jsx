...
const ApplyLicense = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Driving license application submitted successfully! Your application ID is DL' + Date.now());
      setTimeout(() => {
  ...
  return (
    <div className="apply-license">
      <div className="container">
        <div className="page-header">
          <h1>Apply for Driving License</h1>
          <p>Fill in your details to apply for a driving license</p>
        </div>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                <label className="checkbox-label">
                  ...
                  I declare that I am medically fit to drive and have obtained a medical certificate from a registered medical practitioner. *
                </label>
              </div>
            </div>
